...
import (
	...
	"github.com/dewey-typical/orders-project/api/model"
	"github.com/dewey-typical/orders-project/api/repository/order"
...
func (o *Order) List(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Println("failer to find all:", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (o *Order) GetByID(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewEncoder(w).Encode(res); err != nil {
		fmt.Println("failedto marshal:", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
}
